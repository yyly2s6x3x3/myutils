package com.example.utiltest.util;
/**
 *  Android包相关工具类，可用于(root)安装应用、(root)卸载应用、判断是否系统应用等，
 *  如：install(Context, String) 安装应用，如果是系统应用或已经root，则静默安装，否则一般安装uninstall(Context, String) 卸载应用，
 *  如果是系统应用或已经root，则静默卸载，否则一般卸载isSystemApplication(Context, String) 判断应用是否为系统应用
 * */
import java.io.File;
import java.util.List;

import com.example.utiltest.util.ShellUtils.CommandResult;
