 ...
 */
package com.example.utiltest.view;

import java.util.Date;

import com.example.utiltest.util.TimeUtils;
...
public class AbListViewHeader extends LinearLayout {
	...
	private void initView(Context context) {
		...
		//从包里获取的箭头图片
		arrowImage = BitmapFactory.decodeStream(AbPullToRefreshView.class.getResourceAsStream("image/arrow.png"));
		...
		tipsTextview.setTextSize(30);
		headerTimeView.setTextSize(27);
